...
// Represents a snake.
public class Snake {
    public static final int NUTRITION_TO_GROW = 75;
    private Cell head;
    ...
    public int getNutritionConsumed() {
    ...
    // EFFECTS: returns true if snake head is at same position αs any of the cells in the snake body;
    ...
    // MODIFIES: this
    // EFFECTS:  snake rotates counter-clockwise 90 degrees
    ...
    // MODIFIES: this
    // EFFECTS:  snake rotates clockwise 90 degrees
    ...
    // MODIFIES: this, food
    // EFFECTS:  consume the food and add nutritional value of food to nutrition consumed by snake 
